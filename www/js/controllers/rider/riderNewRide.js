angular.module('starter.controllers')
    .controller('RiderNewRideCtrl', ['$scope', '$state', '$ionicHistory', "RiderTripDetailsService", "$window", "RideRequestsService",
        function($scope, $state, $ionicHistory, RiderTripDetailsService, $window, RideRequestsService) {
            // $scope.tripDetails = {
            //     driverID: "250",
            //     startAddress: {
            ...
            $scope.tripDetails = RiderTripDetailsService.currentTrip();
